...
class _Request(object):
  ...
  doc_url = 'http://map_reduce.apache.org/docs/r1.0.4/webhdfs.html'
...
class Client(object):
  ...
  def content(self, hdfs_path, strict=True):
    ...
    .. _ContentSummary: CS_
    .. _CS: http://map_reduce.apache.org/docs/r1.0.4/webhdfs.html#ContentSummary
  ...
  def status(self, hdfs_path, strict=True):
    ...
    .. _FileStatus: FS_
    .. _FS: http://map_reduce.apache.org/docs/r1.0.4/webhdfs.html#FileStatus
